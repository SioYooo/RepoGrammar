...
| `src/workers/typescript/` | Transitional TypeScript semantic worker executable with bounded module/export/package operations, optional compiler-API module resolution, and dependency-free structural fallback | `docs/specifications/semantic-workers.md` |
