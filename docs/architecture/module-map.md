...
| `src/install/` | Source-checkout installer wrapper scripts that call the product binary without duplicating native agent logic | `README.md`, `docs/specifications/installation.md`, `docs/development/testing.md` |
