...
- `release/`: maintainer-owned release runbooks. The stable `0.3.0` checklist
...
- Stable `0.3.0` two-phase immutable publication and instruction-adoption gate:
  `release/stable-v0.3.0-release-checklist.md`.
