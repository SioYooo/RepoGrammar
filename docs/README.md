...
- `release/`: maintainer-owned release runbooks. The stable `0.2.2` checklist
...
- Stable `0.2.2` two-phase immutable publication and instruction-adoption gate:
  `release/stable-v0.2.2-release-checklist.md`.
