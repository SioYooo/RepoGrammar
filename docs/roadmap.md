...
- No-worker exact-anchor FastAPI, pytest, and Pydantic family smoke that proves
  derived support can reach the EC-MVFI-lite family read path without claiming
