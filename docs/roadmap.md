...
- No-worker exact-anchor FastAPI, pytest, Pydantic, and SQLAlchemy family smoke
  that proves derived support can reach the EC-MVFI-lite family read path
  without claiming provider-backed Python semantics.
