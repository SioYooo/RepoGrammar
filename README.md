...
<a href="https://www.star-history.com/#SioYooo/RepoGrammar&Date">
  <picture>
    <source
      media="(prefers-color-scheme: dark)"
      srcset="https://api.star-history.com/svg?repos=SioYooo/RepoGrammar&type=Date&theme=dark"
    />
    <source
      media="(prefers-color-scheme: light)"
      srcset="https://api.star-history.com/svg?repos=SioYooo/RepoGrammar&type=Date"
    />
    <img
      alt="Star History Chart"
      src="https://api.star-history.com/svg?repos=SioYooo/RepoGrammar&type=Date"
    />
  </picture>
</a>
