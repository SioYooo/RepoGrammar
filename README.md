...
| Parsing | Dependency-free syntax-only TS/JS extractor and CPython AST-backed Python extractor store structural code-unit candidates; Python release fixtures smoke this path without creating claims by default | Public parser-backed syntax candidates, not final semantic truth |
