...
Availability is decided by the exact `0.3.1` publication, not by the
...
object contains exactly `"latest":"0.3.1"` and
...
resolves the same `0.3.1` package through npm `latest`. Use the exact version
...
[stable release checklist](https://github.com/SioYooo/RepoGrammar/blob/main/docs/release/stable-v0.3.1-release-checklist.md).
...
RepoGrammar `0.3.1` is the current stable-channel pre-1.0 release. Its
