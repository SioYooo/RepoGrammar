...
| Python SQLAlchemy | Supported | Bounded SQLAlchemy model/repository evidence plus local literal relationship-target context; dynamic declarative behavior and dynamic relationship targets remain conservative. |
