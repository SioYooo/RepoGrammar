...
-> delete the merged branch after main contains it
```

# Required verification

Run all standard checks before merge and again on `main` after merge. Before
deleting the merged branch, verify `main` contains the work by ancestry,
patch-equivalence, PR merge state, or another explicit branch-containment check.
...
Report feature branch, commit hashes, merge commit, branch deletion status,
